        ...
        <div className="who-we-are text-center text-md-left">
            ...
            <div className="content container">
                <div className="row align-items-center">
                    <div className="col">
                        <div class="sponsors">
                            <img class="sponsors__image" src={require("../../assets/Projects/arthublogo.png")} alt="Arts Made Accessible"></img>
                            ...
                            <img class="sponsors__image" src={require("../../assets/Projects/lapluma.png")} alt="Arts Made Accessible"></img>
                            <img class="sponsors__image" src={require("../../assets/Projects/happyart.png")} alt="Arts Made Accessible"></img>
                            <div class="sponsors__text">
                                <p className="lead-p">
                            ...
                            <img class="sponsors__image" src={require("../../assets/Projects/key2music.png")} alt="Arts Made Accessible"></img>
                            ...
                            <img class="sponsors__image" src={require("../../assets/Projects/lovenote.png")} alt="Arts Made Accessible"></img>
                            <img class="sponsors__image" src={require("../../assets/Projects/theDrawingStudio.png")} alt="Arts Made Accessible"></img>
                            <div class="sponsors__text">
                                <p className="lead-p">
