          ...
          <div className="col">
            ...
            <div id="slideshow"> 
              <div class="slide-wrapper"> 
                ...
                <div class="slide"> 
                <img src={require("../../assets/Projects/AMASlides/pic2.png")} alt="" class = 'slideImg'></img> 
                </div> 
                <div class="slide"> 
                <img src={require("../../assets/Projects/AMASlides/pic3.png")} alt="" class = 'slideImg'></img> 
                </div> 
                <div class="slide"> 
                <img src={require("../../assets/Projects/AMASlides/pic4.png")} alt="" class = 'slideImg'></img> 
                </div> 
              </div> 
            </div>
